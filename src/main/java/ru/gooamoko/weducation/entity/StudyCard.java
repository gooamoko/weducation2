...
import static ru.gooamoko.weducation.utils.Utils.getBooleanString;
import static ru.gooamoko.weducation.utils.Utils.getDateString;
...
public class StudyCard implements Serializable {
    ...
    public String getActiveString() {
        return getBooleanString(active);
    }

    public String getRedString() {
        return getBooleanString(red);
    }
    ...
    public String getRemandedString() {
        return getBooleanString(remanded);
    }

    public String getCommercialString() {
        return getBooleanString(commercial);
    }
    ...
    public String getBeginDateString() {
        return getDateString(beginDate);
    }
    ...
    public String getDiplomeDateString() {
        return getDateString(diplomeDate);
    }

    public String getComissionDateString() {
        return getDateString(comissionDate);
    }
